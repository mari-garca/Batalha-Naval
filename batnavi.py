...
print("INSTRUÇÕES:")
print("I) O mapa do jogo tem tamanho 6x6, por isso escolha linhas e colunas entre 1 e 6")
print("II) Você pode, em cada partida:")
...
def jogo(linha,coluna):
    ...
    if matriz[linha-1][coluna-1] == 0:
        ...
        print("Essa posição já foi bombardeada! Você perdeu a vez!")
